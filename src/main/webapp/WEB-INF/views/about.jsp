...
<ul class="list-group ht-tm-element" style="position:fixed">
	...
	<li class="list-group-item list-group-item-action">Maddireddi Venkata Rajeswari​</li>
	<li class="list-group-item list-group-item-action">Tan Chun Ket</li>
	<li class="list-group-item list-group-item-action">Ton That Minh Nhat</li>
</ul>