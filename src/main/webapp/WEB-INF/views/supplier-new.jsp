...
<table class="searchTable">
		<tbody>
			...
			<td colspan="2"><form:button type="submit" class="btn btn-outline-primary" id="allButton"><spring:message code="button.addNew" /></form:button>
				<form:button type="button" class="btn btn-outline-primary" onclick="location.href='${pageContext.request.contextPath}/admin/supplier'"><spring:message code="button.cancel" /></form:button></td>
			</tr>
			</tbody>
		</table>
</form:form>
